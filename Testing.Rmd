...
```{r}
hist(as.numeric(pvals), breaks = seq(0,1,by=0.05), main="Histogram of pvalues, knn without adjustment term", col="gold")
```
```{r}
hist(as.numeric(pvals_2), breaks = seq(0,1,by=0.05), main="Histogram of pvalues, knn with adjustment term", col="gold")
```
