base_analysis_full=function(Y_c_group1, Y_c_group2, channels, group1_ids, group2_ids){
  ...
  predicted_cov_for_group1 <- replicate(length(group1_ids), avg_cov_group2, simplify=FALSE)
  predicted_cov_for_group2 <- replicate(length(group2_ids), avg_cov_group1, simplify=FALSE)
