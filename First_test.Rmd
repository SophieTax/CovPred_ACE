...
for (col in 1:(length(channel_names)-1)){
  for (row in (col+1):length(channel_names)){
    ...
    ttest_short_sleepers$test<-append(ttest_short_sleepers$test, test_current, after=length(test_current))
  }
}
...
for (col in 1:(length(channel_names)-1)){
  for (row in (col+1):length(channel_names)){
    ...
    ttest_conv_sleepers$test<-append(ttest_conv_sleepers$test, test_current, after=length(test_current))
  }
}
