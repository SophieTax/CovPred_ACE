...
Element-wise t test, 1st element ov cov matrix of 1st subject of short
```{r}
tmp1=c(t(triangle_sample_short$mat[,,1]))
tmp1<-tmp1[!is.na(tmp1)]
tmp2=c(t(triangle_pred_short$mat[,,1]))
tmp2<-tmp2[!is.na(tmp2)]
ttest1_1=t.test(x=tmp1[1],y=tmp2[1], paired = TRUE, alternative = "two.sided")
```
